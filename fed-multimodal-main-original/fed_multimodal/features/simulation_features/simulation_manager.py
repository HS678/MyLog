...
class SimulationManager():
    ...
    def simulation(
        ...
        # # 1. simulate modality missing
        # if self.args.missing_modality and datalabel not in ['test', 'dev']:
        #     if seed % 2 == 0:
        #         # 一半客户端：只保留 A
        #         modality_a_missing = 0
        #         modality_b_missing = 1
        #     else:
        #         # 另一半客户端：只保留 B
        #         modality_a_missing = 1
        #         modality_b_missing = 0
        # else:
        #     modality_a_missing = 0
        #     modality_b_missing = 0
        ...
        # if self.args.missing_modality == True:
        #     np.random.seed(seed)
        #     # 0: keep A (B missing), 1: keep B (A missing)
        #     keep_modality = np.random.binomial(n=1, p=0.5)
